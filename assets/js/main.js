...
function startCountdown(targetDate, daysId, hoursId, minutesId, secondsId) {
  var countdownFunction = setInterval(function () {
      ...
      document.getElementById(hoursId).innerHTML = hours + " <span>Saat</span>";
      document.getElementById(minutesId).innerHTML = minutes + " <span>Dakika</span>";
      document.getElementById(secondsId).innerHTML = seconds + " <span>Saniye</span>";
